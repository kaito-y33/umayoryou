...
| 6  | status            | ステータス        | VARCHAR(20)    | NOT NULL                     | プロジェクトの状態         |
| 7  | created_at        | 作成日時          | TIMESTAMP      | DEFAULT CURRENT_TIMESTAMP    | レコード作成日時           |
| 8  | updated_at        | 更新日時          | TIMESTAMP      | ON UPDATE CURRENT_TIMESTAMP  | レコード更新日時           |
